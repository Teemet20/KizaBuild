...
import { ChevronDown, Mail, MessageCircle, Clock, Send } from 'lucide-react';
...
const faqs = [
  {
    ...
    answer: 'No. Kiza is a technology company and membership community. We use the collective power of our members to purchase group insurance policies from licensed providers. You pay us for the platform and management; the insurer holds the risk.',
  },
  {
    question: 'Can I use this for myself if I live in the US?',
    answer: 'No. The healthcare benefits are strictly for beneficiaries residing in our coverage areas (e.g., Nigeria). The Kiza App is for you to manage that coverage.',
  },
  {
    question: 'How do I know the premium is actually paid?',
    answer: 'That is our core promise. Our "Verified" badge is backed by real-time confirmation from the insurer. You can see the validity dates right in your app.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Your family will have access to over 750 of the best private and public hospitals across all 36 states in Nigeria. This includes premium networks like AXA Mansard and Hygeia.',
  },
  {
    question: 'What happens if my family member loses their physical card?',
    answer: 'No problem. Every beneficiary has a Digital Health ID accessible via the Kiza platform. They can show this on any smartphone to gain entry. You can also request a replacement physical card through your dashboard.',
  },
];
    ...
    >
      ...
      <div className="relative px-6 lg:px-[6vw]">
        ...
        <div ref={contactRef} className="mb-20">
          ...
          <h2 className="font-display font-bold text-display-3 text-white mb-10">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white">support@kiza.app</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-kiza-text-secondary">Emergency Support</p>
                  <p className="text-white">24/7 for urgent matters</p>
                </div>
              </div>
            </div>
        ...
        <footer ref={footerRef} className="border-t border-white/10 pt-10">
          ...
          <div className="mt-8 pt-6 border-t border-white/5">
            <p className="text-xs text-kiza-text-secondary/60 leading-relaxed">
              Kiza Inc. is a US-based technology company providing a digital platform for cross-border 
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-kiza-text-secondary/40">
              © {new Date().getFullYear()} Kiza. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
