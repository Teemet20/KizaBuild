...
/**
 * PlansSection  (home page)
 *
 * Simplified two-card plan overview used on the home page (#plans anchor).
 * Shows static international pricing only — the full geo-aware version with
 * the RegionToggle lives on the dedicated /plans page (PlanCardsSection).
 *
 * This section is intentionally simpler: no geo-detection, just enough
 * detail to guide visitors to the /plans page for the full comparison.
 */
