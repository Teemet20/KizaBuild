...
const steps = [
  {
    number: '01',
    title: 'Register',
    description: 'Sign up for a Kiza Care Membership online. It is designed to be seamless.',
    icon: UserPlus,
    color: 'gold',
  },
  {
    ...
    description: 'Create a profile for your Mom, Dad, or Uncle in Nigeria. Our system instantly secures their details.',
    icon: Users,
    color: 'cyan',
  },
  {
      ...
      <div className="relative px-6 lg:px-[6vw]">
        ...
        <div ref={headingRef} className="text-center mb-16 lg:mb-20">
          ...
          <p className="mt-4 text-lg text-kiza-text-secondary-dark">
            From sign-up to coverage in minutes, not days.
          </p>
        </div>
